 ...
 * ```
 */
export function take<T>(limit: number, iterable: AsyncIterable<T>): AsyncGenerator<T, void, unknown>;
export function take<T>(limit: number, iterable: Iterable<T>): Generator<T, void, unknown>;

export function take<T>(limit: number, iterable: Iterable<T> | AsyncIterable<T>): Generator<T, void, unknown> | AsyncGenerator<T, void, unknown> {
